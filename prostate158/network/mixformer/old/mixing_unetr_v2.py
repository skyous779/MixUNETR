...
from prostate158.block.ScConv3d import SRU, CRU
...
class MixAttention(nn.Module):
    ...
    def __init__(
        ...
        self.CRU = CRU(dim)
        self.SRU = SRU(dim // 2, group_num=8)
    ...
    def forward(self, x, D=49, H=49, W=49,  mask=None):
        ...
        # CRU
        x_cnn = self.CRU(x_cnn) # torch.Size([2, 48, 49, 49, 49])
