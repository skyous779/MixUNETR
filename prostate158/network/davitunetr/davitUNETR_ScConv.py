...
LastEditTime: 2024-03-05 17:19:57
FilePath: /prostate158-main/prostate158/network/davitUNETR_ScConv.py
...
class davitUNETR_scconv(nn.Module):
    """
    ...
    def forward(self, x_in):
        ...
        # skip connection
        enc1_ = self.ScConv3_24(self.ScConv2_24(self.ScConv24(enc1)))
        enc2_ = self.ScConv2_48(self.ScConv48(enc2)) 
        enc3_ = self.ScConv96(enc3)
        enc4_ = self.ScConv192(enc4)


        # chvit_out = self.ChViT([enc1, enc2, enc3, enc4])

        # dec4 = self.encoder10(hidden_states_out[4])
        dec3 = self.decoder5(hidden_states_out[4], enc4_)
        ...
        for i in range(depth):
            self.block_.append(
                SpatialBlock(
                    ...
                    use_checkpoint=use_checkpoint,
                    qkv_mode=qkv_mode,
                ) if i%2==0 else  # 改变SpatialBlock和ChannelBlock的顺序，得到DaViTUNETRv2
                ChannelBlock(
                        dim=dim,
                        num_heads=num_heads,
                        mlp_ratio=mlp_ratio,
