...
Date: 2024-01-16 19:51:34
LastEditors: skyous 1019364238@qq.com
LastEditTime: 2024-01-20 19:17:45
FilePath: /prostate158-main/prostate158/davitUNETR_v3_3.py
Description: use for davit + unet in encoder or skip connetion!
...
class davitUNETR(nn.Module):
    ...
    #     enc1 = self.encoder2(self.down_1(enc0))
    #     enc2 = self.encoder3(self.down_2(enc1))
    #     enc3 = self.encoder4(self.down_3(enc2))
    #     enc4 = self.encoder5(self.down_4(enc3))
    ...
    def forward(self, x_in):
        ...
        # dec4 = self.encoder10(hidden_states_out[4])
        dec3 = self.decoder5(self.down_5(enc4), chvit_out[3])
        dec2 = self.decoder4(dec3, chvit_out[2])
        dec1 = self.decoder3(dec2, chvit_out[1])
        dec0 = self.decoder2(dec1, chvit_out[0])
        out = self.decoder1(dec0, enc0)
        logits = self.out(out)
        return logits
